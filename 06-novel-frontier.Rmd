...
So far, we have been concerned only with cylindrical algebraic decompositions compatible with subsets of $\R^n$ having
dimension at most $2$. We will now present a novel algorithm for obtaining the frontier condition on a cylindrical algebraic decomposition of $\R^n$ compatible with a set of arbitrary dimension.
...
An algorithm for constructing such a CAD is presented by @collins1991, and an alternative approach is presented by @bradford2016.
