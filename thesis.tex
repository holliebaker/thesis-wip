...
\item
  ...
  \item
    ...
    {\cal R} := \{ {\cal R}_{\mathbf{b}} =  (c_1,\ldots,c_t ) \subset \mathbb{A}\mid \mathbf{b} \in \mathbb{R}^{k-1}  \}
    \]
    where is a \((0,\ldots,0)\)-cell in the decomposition induced by \({\cal E}\) on \(\mathbb{R}^k\),
...
\caption{Plot of the 2-dimensional cell from Example \\ref{exm:qanm}.}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Plot of the CAD with monotone cells, compatible with the 2-dimensional cell presented in Example \\ref{exm:qanm}.}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{$C$, with ${\operatorname{fr} \left( C \right)}$ superimposed, from Example \\ref{exm:top-bottom-not-cylindrical}, demonstrating that $C_B$ is not the graph of a continuous function.}\label{fig:unnamed-chunk-10}
\end{figure}
...
\addcontentsline{toc}{chapter}{Appendix A: Test Cases}
