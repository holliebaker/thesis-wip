...
We now recall two definitions which will be used throughout this thesis. 
...
We will also need the notion of a critical point of a function, which is defined, following @@firststeps, as follows:
