...
[@tarski1951]
Let $S \subset \R^{n+1}$ and $\projop{n} : \R^{n+1} \to \R^n$ be the projection map onto the first $n$ coordinates. Then $\projop{n}(S) \subset \R^n$ is a semialgebraic set.
:::
...
We note the existence of an algorithm for performing quantifier elimination over real numbers. This algorithm will be used to provide theoretical complexity bounds for solving quantifier elimination problems later.
