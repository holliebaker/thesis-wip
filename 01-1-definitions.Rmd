...
$Y \subset \opspan{x_1,\ldots,x_n}$ is called a monotone cell if it is the graph of a monotone map $\mathbf{f} : X \to H$ where $H \subset \opspan{x_1,\ldots,x_n}$ and $X \subset \opspan{x_1,\ldots,x_n} \setminus H$. If $X \subset \opspan{x_1,\ldots,x_n}$ (i.e., $H = \emptyset$, equivalently $Y$ coincides with $X$), tehn $Y$ is called a semi-monotone set. 
:::
