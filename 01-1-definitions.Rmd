...
As such, we will be working with multivariate polynomials $f$ in variables $x_1,\ldots,x_n$ with coefficients in a field $Z$. These will be denoted as elements of $Z[x_1,\ldots,x_n]$. 
