...
Since $W'_k$ has codimension $n-k$ and is a basic semialgebraic set, its formula contains $n-k$ polynomial equations $h_1,\ldots,h_k$ and, possibly, some inequalities.
...
\State \Comment{stratify the input sets}
\State $(\mathcal{W}_1, \mathcal{W}_2) = \textproc{SmoothLocus}(\{ F_1 \lor \ldots \lor F_k \})$
...
\For {each stratum $W'_1 \in \mathcal{W}_2$ and each $1 \le i \le n$}
