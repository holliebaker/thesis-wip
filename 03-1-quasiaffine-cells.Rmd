...
Let $C \subset V$ be a $2$-dimensional be a cell of $\mathcal{E}$, and suppose it has binary index $(i_1,\ldots,i_n)$.
Since $\dim(C) = 2$, $\sum_{1\le i \le n} = 2$. Let $i_{j_1}, = i_{j_2} = 1$ for $j_1 \ne j_2$ while all other elements
