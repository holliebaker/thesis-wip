...
In this section, we develop an algorithm, based on @bgv15, Theorem 3.19, for constructing a CAD whose two-, one-, and
...
## Computing the smooth $2$-dimensional locus of the input set
...
Similarly for $1$-dimensional cells, only one element of the index will be equal to $1$, while all other elements are
