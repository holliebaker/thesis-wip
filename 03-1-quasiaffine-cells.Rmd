...
More specifically, according to [@collins1988 Theorems 2.2.3 and 2.2.4], if there is a finite number of blow-up poits, which will be the case since input sets have dimension at most 2, then smooth cells will be obtained if McCallus's projection operator is used. 
