...
Additional illustrative examples are presented in Appendix \@ref(sec:more-tests) along with a comparison of the number
of cells, number of polynomials and average running time taken to construct a monotone CAD vs a classical CAD in `QEPCAD-B`.
