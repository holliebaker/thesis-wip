...
$1$-dimensional components of its side-wall are $1$-dimensional section cells. This condition may be impossible, even in $\R^3$, as Example \@ref(exm:side-wall) demonstrates.
...
Observe that $I = \{ (0,0,z) \mid 0 \le z \le 1 \}$ is the only $1$-dimensional component of the side-wall of $V$ and
$I_1$ is the only $1$-dimensional component of the side-wall of $W$. In order to obtain the strong frontier condition,
...
$$
is a cylindrical $(i_1,\ldots,i_{k-1},i_{k+1},\ldots,i_n)$-cell and $C$ is the graph of a monotone map $f \colon C' \to \opspan{x_k}$.
:::
...
The algorithm proposed by @brown99 is implemented as the "solution formula construction phase" in `QEPCAD-B`. A small modification has been made such that this algorithm may be used to construct formulas for individual cells as opposed to the set of points satisfying the input formula. More precisely, the definition of a conflicting pair was slightly modified.
