...
continuous functions (see Definition \@ref(def:blow-up-point) and Example \@ref(exm:top-bottom-not-cylindrical)).
...
of $\cal D$ onto $\R^{n-1}$ is either disjoint or identical.
...
$1$-dimensional components of its side-walls are $1$-dimensional section cells. This condition may be impossible, even
