...
## 2-dimensional monotone sector cells {#sec:monotone-sectors}
...
### Working in the sub-decomposition above a 0-cell { #sec:sub-cad }
...
## 2-dimensional monotone section cells { #sec:monotone-sections }
