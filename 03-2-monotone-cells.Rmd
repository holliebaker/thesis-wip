...
$$
which computes $h := g(\mathbf{y}) \in \A[x_{1},\ldots,x_m]$ and returns the normalised polynomial of $h$, in
$\Z[x_{m+1},\ldots,x_n]$ (see Section \@ref(sec:sub-cad)).
...
$$
$\mathbf{b}$ is a $(0,\ldots,0)$-cell in the decomposition induced by ${\cal E}$ on $\R^{k-1}$.
...
Consider each cell $C$ of $\cal D$ with truth value *true*. Let $C$ have binary index
$$
