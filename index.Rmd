...
can sometimes exibit undesirable properties when blow-up points are present. This can make it more difficult to reason
...
with a family of semialgebraic sets, each having dimension at most two, and such that each cylinddrical cell is
