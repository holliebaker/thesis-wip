...
In 1957, @whitney1992 proved that every algebraic variety -- the set of real solutions to a system of multivariate polynomial equations -- can be partitioned into a finite set of smooth manifolds, each of which is a semialgebraic set.
...
This algorithm has been implemented in C, using the computer algebra library `SACLIB`. `QEPCAD-B` is used to perform emptyness checks using cylindrical algebraic decomposition. Below is an example of the program's output, given the basic semialgebraic set
$$
