...
@gv1995, Theorem 2 assert that each stratum of codimension $k$ can be represented by a conjunction containing at least $k$
...
Since `QEPCAD-B` assigns a truth value to each cell by evaluating its sample point against the input formula, if $S$ is
empty, then this CAD will contain no true cells. Therefore, the function checks whether there are any true cells.
